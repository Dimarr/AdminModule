...
?>
    ...
    <form name="form" method="post" action="">
        <table>
            ...
            <td><p><label for="bn"><b>Seller inc. code</b></label>
            <input type="txt" name="bn" placeholder="Seller inc. code" value="<?php echo $bbn ?>" /></p></td>
            <td><p><label for="bnid"><b>Seller social ID</b></label>
            <input type="txt" name="bnid" placeholder="Seller social ID" value="<?php echo $bbnid ?>" /></p></td></tr>
            <tr><td width="200"><p><label for="bystype"><b>Birthdate</b></label></td>
            <td width="500"><input type="date" name="bdate" placeholder="Birthdate" value="<?php echo $row[3] ?>" required /></p></td>
            <td width="200"><p><label for="sidate"><b>Social ID Issue Date</b></label></td>
            <td width="500"><input type="date" name="sidate" placeholder="Social ID Issue Date" value="<?php echo $row[4] ?>" required /></p></td></tr>
            <tr><td width="200"><p><label for="country"><b>Country</b></label></td>
            <td width="500"><input type="text" name="country" placeholder="Your Country" value="<?php echo $row[7] ?>" required /></p></td>
            <td width="200"><p><label for="sellercity"><b>City</b></label></td>
            <td width="500"><input type="text" name="sellercity" placeholder="City" value="<?php echo $row[17] ?>" required /></p></td></tr>
            <tr><td width="200"><p><label for="street"><b>Street</b></label></td>
            <td width="500"><input type="text" name="street" placeholder="Street" value="<?php echo $row[5] ?>" required /></p></td>
            <td width="200"><p><label for="streetnmb"><b>Building Number</b></label></td>
            <td width="500"><input type="number" name="streetnmb" placeholder="Building number" value="<?php echo $row[6] ?>" required /></p></td></tr>
            <tr><td width="200"><p><label for="url"><b>Your site</b></label></td>
            <td width="500"><input type="text" name="url" placeholder="Your URL" value="<?php echo $row[8] ?>" required /></p></td>
            <td width="200"><p><label for="gender"><b>Gender</b></label></td>
            <td width="500"><input type="number" name="gender" placeholder="0 - male, 1- female" value="<?php echo $row[12] ?>" required /></p></td></tr>
            <tr><td width="200"><p><label for="sellerinc"><b>Seller's incorporation type</b></label></td>
            <td width="500"><input type="number" name="sellerinc" placeholder="0 - individual, 2 - business" value="<?php echo $row[13] ?>" required /></p></td>
            <td width="200"><p><label for="mrchntname"><b>Name of Merchant</b></label></td>
            <td width="500"><input type="text" name="mrchntname" placeholder="Name of Merchant" value="<?php echo $row[11] ?>" /></p></td></tr>
            <tr><td width="200"><p><label for="filesocialid"><b>URL to Social ID photo</b></label></td>
            <td width="500"><input type="text" name="filesocialid" placeholder="URL to Social ID photo" value="<?php echo $row[14] ?>" required /></p></td>
            <td width="200"><p><label for="filecheque"><b>URL to proof of bank account ownership</b></label></td>
            <td width="500"><input type="text" name="filecheque" placeholder="URL to proof of bank account ownership" value="<?php echo $row[15] ?>" required /></p></td></tr>
